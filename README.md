...
* gtest / ab для тестирования MVP и rate limiter соответственно. Curl для GET / POST запросов в рамках тестирования. bash-script для запусков тестов / облегчения работы с разработкой
