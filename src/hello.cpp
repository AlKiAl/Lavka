...
namespace pg_service_template {
    ...
    namespace {
	    ...
	    public:
	      ...
	      Hello(const userver::components::ComponentConfig& config, const userver::components::ComponentContext& component_context)
    ...
    void AppendHello(userver::components::ComponentList& component_list) {
      component_list.Append<Hello>(); // Hello defenition in namespace{/**/};
